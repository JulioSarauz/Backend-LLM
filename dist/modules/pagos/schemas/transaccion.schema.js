...
__decorate([
    ...
    __metadata("design:type", String)
], Transaccion.prototype, "paypalOrderId", void 0);
__decorate([
    (0, mongoose_1.Prop)({ required: true }),
...
__decorate([
    (0, mongoose_1.Prop)({ required: true }),
    __metadata("design:type", Number)
], Transaccion.prototype, "tokensAdquiridos", void 0);
__decorate([
    (0, mongoose_1.Prop)({ required: true, enum: ['PENDING', 'COMPLETED', 'FAILED'], default: 'PENDING' }),
    __metadata("design:type", String)
